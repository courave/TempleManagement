<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="type.aspx.cs" Inherits="CWCS_OL.tables.gongde.type" %>
...
<body>
    ...
    <div>
        ...
        类型名称：<asp:TextBox ID="TextBox_type" runat="server"></asp:TextBox>
        <br />
