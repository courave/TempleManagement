<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="CWCS_OL.tables.sanshi.edit" %>
    ...
    <script type="text/javascript" src="../../Scripts/My97DatePicker/WdatePicker.js"></script>
        <script type="text/javascript">
            ...
            function newSelector() {
                window.open('selector.aspx?type=changnian', 'newwindow', 'toolbar=no,menubar=no,location=no,status=no,scrollbars=yes');
                return false;
            }
    </script>
</head>
<body>
    ...
    <div>
        ...
        <br />
        编号：<asp:TextBox ID="TextBox_sanshi_no" runat="server"></asp:TextBox>
        <br />
    字号：<asp:TextBox ID="TextBox_zihao" runat="server"></asp:TextBox>
        <br />
    座次：<asp:TextBox ID="TextBox_zuoci" runat="server"></asp:TextBox>
        <br />
    方位：<asp:TextBox ID="TextBox_fangwei" runat="server" style="width:90px"></asp:TextBox>
    &nbsp;
    排：<asp:TextBox ID="TextBox_row" runat="server" style="width:60px"></asp:TextBox>
    &nbsp;
    座：<asp:TextBox ID="TextBox_col" runat="server" style="width:60px"></asp:TextBox>
    &nbsp;
    <input type="button" id="btnSelect" name="btnSelect" value="选择" onclick="newSelector();" />
    <br />
