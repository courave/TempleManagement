<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="CWCS_OL.tables.fahua.detail" %>
...
<body>
    ...
    法会名称：<asp:Label ID="Label_fahui_name" runat="server"></asp:Label>
        <br />
    编号：<asp:Label ID="Label_fahua_no" runat="server"></asp:Label>
        <br />
