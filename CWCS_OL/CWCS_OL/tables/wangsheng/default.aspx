<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="CWCS_OL.tables.wangsheng._default" %>
...
<div id="toolbar">
    <select id="SelectNav" onchange="SelectNav_onChange()">
        ...
        <input type="button" value="新增(N)" onclick="return addNew();" accesskey="n" />
...
<div id="frameSet" runat="server">
    <iframe src="list.aspx" id="list" width="100%" style="border:none;" frameborder="0" runat="server"></iframe>
</div>
