<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="CWCS_OL.tables.stock.outstock.list" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FromTo" HeaderText="去向" 
                    SortExpression="FromTo" />
                <asp:BoundField DataField="Manager" HeaderText="负责人" 
                    SortExpression="Manager" />
                <asp:BoundField DataField="EditTime" HeaderText="出库时间" 
