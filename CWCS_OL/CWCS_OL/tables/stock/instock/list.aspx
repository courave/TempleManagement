<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="CWCS_OL.tables.stock.instock.list" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FromTo" HeaderText="来源" 
                    SortExpression="FromTo" />
                <asp:BoundField DataField="Manager" HeaderText="负责人" 
                    SortExpression="Manager" />
                <asp:BoundField DataField="EditTime" HeaderText="入库时间" 
