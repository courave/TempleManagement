...
public static class ChinaDate
{
    ...
    /// <returns></returns>
    public static int GetMaxMonth(DateTime dt)
    {
        int year = china.GetYear(dt);
        return china.GetMonthsInYear(year);
    }
    ...
    /// </summary>
    /// <returns></returns>
    public static DateTime GetFirstMonth(int year, int month = 1)
    {
        return china.ToDateTime(year, month, 1, 0, 0, 0, 0);
    }
    ...
    /// <param name="dt">时间</param>
    /// <returns></returns>
    public static int GetMaxDay(DateTime dt)
    {
        int year = china.GetYear(dt);
        int month = china.GetMonth(dt);
        return china.GetDaysInMonth(year, month);
    }
    ...
    public static string GetYear(DateTime dt)
    {
        ...
        //string str = string.Format("[{1}]{2}{3}年{0}", year, yearSX[yDZ], yearTG[yTG], yearDZ[yDZ]);
        string str = string.Format("{1}{2}年({0})", year, yearTG[yTG], yearDZ[yDZ]);
        return str;
    }

    public static int GetYearNum(DateTime dt)
    {
        return china.GetYear(dt);
    }
    ...
    public static int GetMonthNum(DateTime dt)
    {
        return china.GetMonth(dt);
    }
    ...
    public static DateTime AddDateMonth(DateTime dt,int month)
    {
        return china.AddMonths(dt, month);
    }

    public static DateTime AddDateDay(DateTime dt,int day)
    {
        return china.AddDays(dt, day);
    }
