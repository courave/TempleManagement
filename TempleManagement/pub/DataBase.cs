...
namespace TempleManagement.pub
{
    public class DataBase : IDisposable
    {
        ...
        public static string connStr = "Data Source=vmwinxp\\SQLEXPRESS;Initial Catalog=TEMPLE_CWCS;User ID=cwcs;Password=cwcs";
        public DataBase(): this("Data Source=vmwinxp\\SQLEXPRESS;Initial Catalog=TEMPLE_CWCS;User ID=cwcs;Password=cwcs"){}
        public DataBase(string connectionString)
        {
            if (connectionString == null || connectionString == "")
            {
                connectionString = "Data Source=vmwinxp\\SQLEXPRESS;Initial Catalog=TEMPLE_CWCS;User ID=cwcs;Password=cwcs";
            }
