...
namespace TempleManagement.pub
{
    public static class ChinaDate
    {
        ...
        public static string GetChinaDate(DateTime dt)
        {
            ...
            {
                return string.Format("日期超出范围！必须在{0}到{1}之间！", china.MinSupportedDateTime.ToString("yyyy-MM-dd"), china.MaxSupportedDateTime.ToString("yyyy-MM-dd"));
        ...
        public static string GetYear(DateTime dt)
        {
            ...
            string str = string.Format("[{0}]{1}{2}年",yearSX[yDZ], yearTG[yTG], yearDZ[yDZ]);
            return str;
        }
